...
The same five 1280x800 images go to all three stores, in this order. Four
are generated; screenshot 2 is captured by hand on x.com. Make sure all five
...
| 2 | `store/screenshot-2-highlight-1280x800.png` | Owner capture, then `node scripts/render-brand.mjs` |
