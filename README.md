...
Output: `release/x-country-block-0.1.1-firefox.zip`
...
Output: `release/x-country-block-0.1.1-source.zip` (TypeScript source, build scripts, no `node_modules/` or built JS).
